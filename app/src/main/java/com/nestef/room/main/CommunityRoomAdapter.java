 ...
 */
public class CommunityRoomAdapter extends RecyclerView.Adapter<CommunityRoomAdapter.RoomViewHolder> {
    private static final String TAG = "RoomAdapter";
    private List<Room> mRooms;
    private CommunityRoomAdapter.RoomCallback mCallback;

    public CommunityRoomAdapter(List<Room> rooms) {
        mRooms = rooms;
    }

    public CommunityRoomAdapter(List<Room> rooms, CommunityRoomAdapter.RoomCallback callback) {
        mRooms = rooms;
        mCallback = callback;
    }
    ...
    @NonNull
    @Override
    public CommunityRoomAdapter.RoomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.room_list_item, parent, false);
        return new CommunityRoomAdapter.RoomViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CommunityRoomAdapter.RoomViewHolder holder, int position) {
